...
class Transfer(models.Model):
    id = models.BigAutoField(primary_key=True)
    from_account_id = models.ForeignKey(Account, to_field='id', db_column='from_account_id', on_delete=models.CASCADE, related_name='outgoing_transfers')
    to_account_id = models.ForeignKey(Account, to_field='id', db_column='to_account_id', on_delete=models.CASCADE, related_name='incoming_transfers')
