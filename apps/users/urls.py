...
from .views import CreateUserView, LoginUserView, RenewAccessTokenView, UpdateUserView, VerifyEmailView
from rest_framework_simplejwt.views import TokenRefreshView

urlpatterns = [
    path('', CreateUserView.as_view(), name='create-user'),
    path('login/', LoginUserView.as_view(), name='login-user'),
    path('token/renew_access/', RenewAccessTokenView.as_view(), name='renew-access-token'),
