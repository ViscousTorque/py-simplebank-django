...
#   rds_subnet_ids = ["subnet-94869ff2", "subnet-cc38d087", "subnet-d3653f89"]
#   # rds_db_subnet_group_name = module.vpc.db_subnet_group_name
#   rds_db_subnet_group_name = "default-vpc-c4d679bd" # found in rds subnet groups
#   # vpc_security_group_ids   = [module.security_group.security_group_id]
#   vpc_security_group_ids = ["sg-04e9d02071615c361"] #ID not sg group name, access my ip security created here, #will need to add eks sg later
# }
